...
#include "ProjectilesDefault.generated.h"

UCLASS()
class TDS_API AProjectilesDefault : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	class USphereComponent* SphereOfDistanceDamage = nullptr;// <<< For grenade.
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"), Category = Components)
	...
	FShellBullets ShellBulletSetting;
	
	//Functions.
	void InitProjectile(FProjectileInfo InitParam);
	void InitShellBullet(FShellBullets ShellBullet);
	UFUNCTION()
